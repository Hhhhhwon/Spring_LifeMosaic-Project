...
### 👉 좋아요 싫어요 기능  중복 선택 및 그래프 수치화 실시간반영  (Axios)
...
### 👉 댓글, 대댓글 CRUD 구현현 및 태그 명확화 (Axios)
...
# 💭 느낀 점
프로젝트를 통해 팀원들과의 협업, 기능 구현, 디자인 등 다양한 경험을 쌓을 수 있었습니다. 특히, 사용자 중심의 디자인과 좋은 UX를 고려한 결과물을 만들 수 있어 뿌듯하게 생각합니다. 프로젝트를 진행하면서 첫 번째 프로젝트에서는 하나의 기능에 너무 많은 시간을 할애하여 팀원들에 비해 뒤쳐진 느낌을 받았습니다. 그러나 이 경험을 토대로 현재 진행 중인 두 번째 프로젝트에서는 스프링 시큐리티 개념을 공부하여 첫번 쨰 프로젝트에 비해 시간을 적게 사용하여 [소셜 로그인](https://github.com/Hhhhhwon/spring-boot-JPA)을 구현하는 데에 성공했습니다.
